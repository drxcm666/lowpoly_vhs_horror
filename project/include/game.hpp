...
public:
    Game();
    ~Game();
    void setDialogueStyle(const Font &font, int screenWidth, int screenHeight, float fontSize,
                          Color mainColor, Color outlineColor, float outlineWidth)
    {
        dialogue_.setStyle(font, screenWidth, screenHeight, fontSize, mainColor, outlineColor, outlineWidth);
        hudFont_ = &font;
    }
